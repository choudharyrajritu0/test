...
<body class="no-scroll-preload">
    ...
    <center>
        <!-- Home Section -->
        <div class="text col-sm-6" style="margin-top: 140px;">Hi <span class="wave"><img src="assets/images/Hand.gif" width="35px"></span>&nbsp; I'm <span class="header">Ritu Raj choudhary</span>
            <div class="center">
                <div style="margin-top: 50px;">
                    
                    <img src="assets/images/dp_me.jpg" alt="" class="rounded-circle" height="400" width="400">
                </div>
                <br/>
                <span style="display: inline;"> <span class="animated-text"
                    data-words="Cyber securtiy Enthusiast"></span>
                </span>
                <div>
                    <div class="social-icons">

                        <a class="socialicon twitter" href="https://twitter.com/rrchoudhary0001" target="_blank" rel="author">
                        ...
                        <a class="socialicon email icon-cont" href="" target="_blank" rel="author">
                            ...
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Gmail_icon_%282020%29.svg/1024px-Gmail_icon_%282020%29.svg.png" alt="gmail" width="45" height="30" />
                        </a>

                        <a class="socialicon linkedin" href="https://www.linkedin.com/in/ritu-raj-choudhary-44202620b/" target="_blank" rel="author">
                        ...
                        <a class="socialicon codechef icon-cont" href="" target="_blank" rel="author">
                            ...
                            <img src="https://static.uacdn.net/thumbnail/external-app-icons/ce4fd2180646452aa0b03c3ffa3ef8e2.png" alt="codechef" width="60" height="50" />
                        </a>

                        <!-- <a class="socialicon email" href="" target="_blank" rel="author">
                            <i class="fab fa-kaggle"></i>
                        </a> -->

                        <a class="socialicon instagram" href="https://www.instagram.com/accounts/login/?next=/choudhary_raj_ritu/" target="_blank" rel="author">
                        ...
                        <a class="socialicon github" href="https://github.com/choudharyrajritu1" target="_blank" rel="author">
                   ...
                   <button id="" type="button" href="https://github.com/choudharyrajritu1"  value="Download CV" >Download CV</button>
                </div>
            </div>
        </div>
    </center>
